...
<!-- 
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" id="image" class="form-control" required style=" box-shadow: 3px 3px  6px  #3f5378 !important;">
                        </div>
        ...
        <div class="col-lg-6 mb-4 ">
            <div class="card"  style=" box-shadow: 3px 3px 6px  #3f5378 !important;">
                ...
                <div class="card-body p-0" style="max-height:630px; overflow-y:auto; overflow-x:hidden;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <h3 class="my-3">${list.product}</h3>
                                                <small class="mr-2"><i class="fa fa-eye "></i> ${list.no_views} Views</small>
